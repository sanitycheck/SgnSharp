...
{
    public static readonly string[] ConditionalJumpMnemonics = 
    [
        "JAE",
        "JA",
        "JBE",
    ...
    public static readonly string[] SafeGarbageInstructions =
    [
    ...
    public static readonly string[] SupportedOperandTypes = 
    [
        "imm8",
        "imm16",
        "imm32",
    ...
    public static readonly byte[] X86_REG_SAVE_PREFIX = [0x60, 0x9c]; // PUSHAD, PUSHFD

    // X86_REG_SAVE_SUFFIX instructions for restoring registers from stack
    public static readonly byte[] X86_REG_SAVE_SUFFIX = [0x9d, 0x61]; // POPFD, POPAD

    // X64_REG_SAVE_PREFIX instructions for saving registers to stack
    public static readonly byte[] X64_REG_SAVE_PREFIX =
    [
    ...
    // X64_REG_SAVE_SUFFIX instructions for restoring registers from stack
    public static readonly byte[] X64_REG_SAVE_SUFFIX =
    [
    ...
    public const string InstructionSet = $$"""
